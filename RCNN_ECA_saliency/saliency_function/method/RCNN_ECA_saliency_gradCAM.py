...
def visualize_protein_gradient(protein_list, gradients, lengths, dictionary, true_label):
    for i in range(len(protein_list)):
        ...
        if true_label[i] == 1:  # 阳性为1
            ...
            # savepath = save_dir_path + 'PhasepDB_R_data/pos_sequence_score/RCNN_ECA_protein_score.csv'
            # savepath = save_dir_path + 'PhasepDB_T_data/pos_sequence_score/RCNN_ECA_protein_score.csv'
            ...
            # savepath = save_dir_path + '20211207_data/neg_sequence_score/RCNN_ECA_protein_score.csv'.
            # savepath = save_dir_path + 'LLPS_data/neg_sequence_score/RCNN_ECA_protein_score.csv'
            # savepath = save_dir_path + 'PhasepDB_R_data/neg_sequence_score/RCNN_ECA_protein_score.csv'
            # savepath = save_dir_path + 'PhasepDB_T_data/neg_sequence_score/RCNN_ECA_protein_score.csv'
        ...
        if true_label[i] == 1:  # 阳性为1
            # savepath1 = save_dir_path + '20211207_data/pos_sequence_statics/RCNN_ECA_protein_statics.csv'
            # savepath1 = save_dir_path + 'LLPS_data/pos_sequence_statics/RCNN_ECA_protein_statics.csv'
            # savepath1 = save_dir_path + 'PhasepDB_R_data/pos_sequence_statics/RCNN_ECA_protein_statics.csv'
            # savepath1 = save_dir_path + 'PhasepDB_T_data/pos_sequence_statics/RCNN_ECA_protein_statics.csv'
            ...
            # savepath1 = save_dir_path + '20211207_data/neg_sequence_statics/RCNN_ECA_protein_statics.csv'
            # savepath1 = save_dir_path + 'LLPS_data/neg_sequence_statics/RCNN_ECA_protein_statics.csv'
            # savepath1 = save_dir_path + 'PhasepDB_R_data/neg_sequence_statics/RCNN_ECA_protein_statics.csv'
            # savepath1 = save_dir_path + 'PhasepDB_T_data/neg_sequence_statics/RCNN_ECA_protein_statics.csv'
...
if __name__== '__main__':
    ...
    state_dict = torch.load('../../save_model/mydata_1507_RCNN_ECA_089-0.9930.pt')
    # state_dict = torch.load('./RCNN_ECA_save_model/LLPS_RCNN_ECA_100-1.0000.pt')
    # state_dict = torch.load('./RCNN_ECA_save_model/PhasepDB_R_RCNN_ECA_096-1.0000.pt')
    # state_dict = torch.load('./RCNN_ECA_save_model/PhasepDB_T_RCNN_ECA_099-0.9983.pt')
