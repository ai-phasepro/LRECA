...
if __name__== '__main__':
    ...
    segment_savepath = './density_segment/density_segment_test3/'
    ...
    # index_list, max_segment_idx_list, max_protein_segment_list, protein_segments_list, log_density_segments_list, process_density_segments_list, score_list, area_list = find_max_segment(
    #     train_proteins_names, train_proteins, log_density_list, segment_savepath)
    ...
    # density_savepath = './RCNN_ECA_saliency/LCRs_process/density_map/LCRs_protein_densitymap_train2'
    # density_savepath = './RCNN_ECA_saliency/LCRs_process/density_map/LCRs_protein_densitymap_test2'
    # density_savepath = './RCNN_ECA_saliency/LCRs_process/density_map/LCRs_protein_densitymap_train3'
    # density_savepath = './RCNN_ECA_saliency/LCRs_process/density_map/LCRs_protein_densitymap_test3'
    # save_density(density_savepath +'.csv', train_proteins_names, train_proteins, train_scores, log_density_list)
    # draw_density_heatmap(density_savepath +'.png', train_proteins_names, train_proteins, log_density_list)

    # picture_savepath = './RCNN_ECA_saliency/LCRs_process/density_map/score_density_picture/'
    # draw_score(picture_savepath+'LCRs_protein_score_train2_', train_proteins_names, train_proteins, train_scores)
    # draw_density(picture_savepath+'LCRs_protein_density_train2_', train_proteins_names, train_proteins, log_density_list)
