...
if __name__== '__main__':
    FUS_test_path='./output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/FUS_family/FUS_train_statics.csv'
    ...
    segment_savepath = './output/LCRs_process/density_segment/density_segment_train/'
    ...
    density_savepath = './output/LCRs_process/density_map/LCRs_protein_densitymap_train'
