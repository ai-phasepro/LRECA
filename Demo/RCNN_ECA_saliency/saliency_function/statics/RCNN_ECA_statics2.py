...
if __name__== '__main__':
    ...
    protein_class_path = dir_path + 'mydata/'
    ...
    test_protein_file_name = 'test_dataset/mydata_test.xlsx'
    ...
    for idx in range(len(verify_proteins_list)):
        ...
        if verify_protein in search_protein_dataset:
            ...
            save_test_protein_statics(protein_class_path + 'mydata_test_statics.csv', verify_name, searchprotein, searchscore)
        else:
            print(verify_name)
            continue
    print('success')
