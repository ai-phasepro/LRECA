...
if __name__== '__main__':
    ...
    test_protein_file_name = 'test_dataset/FUS_family_train.xlsx'
    ...
    for idx in range(len(verify_proteins_list)):
        ...
        if verify_protein in search_protein_dataset:
            ...
            save_test_protein_statics(protein_class_path + 'FUS_train_statics.csv', verify_name, searchprotein, searchscore)
        else:
            print(verify_name)
            continue
    print('success')
