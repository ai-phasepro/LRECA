...
if __name__== '__main__':
    ...
    set_seed(seed)
    root_dir = '/data'
    pos_protein_dir = 'processed_dataset/pos_dataset/pos_word_list_LLPS.txt'
    ...
    for i in range(len(pos_seed_list)):
        ...
        auc_save_csv = '/results/classification_output/dataset_RCNN_ECA_output/LLPS_output/r3/RCNN_em2048_128_output/rcnn_ECA_LLPS_epoch100_roc_{}.csv'.format((i+10))
        result_save_csv = '/results/classification_output/dataset_RCNN_ECA_output/LLPS_output/r3/RCNN_em2048_128_output/result.csv'
