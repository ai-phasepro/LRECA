...
if __name__== '__main__':
    FUS_test_path='Saliency_output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/FUS_family/FUS_test_statics.csv'
    ...
    segment_savepath = 'Saliency_output/LCRs_process/FUS_family/density_segment/density_segment_train/'
    density_savepath = 'Saliency_output/LCRs_process/FUS_family/density_map/LCRs_protein_densitymap_train'
    if not os.path.exists('Saliency_output/LCRs_process/FUS_family/density_map/'):
        os.makedirs('Saliency_output/LCRs_process/FUS_family/density_map/')
