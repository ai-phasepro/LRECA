...
if __name__== '__main__':
    ...
    pos_test_dir = '../test_dataset/pos_dataset/pos_word_list_LLPS_test'
    neg_test_dir = '../test_dataset/neg_dataset/neg_word_list_LLPS_test'
    model_path = '../trained_model/model_LLPS_1.pt'
    ...
    for i in range(len(pos_seed_list)):
        ...
        if not os.path.exists("../classification_output/LLPS_output"):
            os.makedirs("../classification_output/LLPS_output")
