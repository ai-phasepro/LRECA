...
if __name__== '__main__':
    ...
    if not os.path.exists('../../../Saliency_output/LCRs_process/personal/density_segment/density_segment_picture'):
        os.makedirs('../../../Saliency_output/LCRs_process/personal/density_segment/density_segment_picture')
