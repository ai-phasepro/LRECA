...
for idx, seq in enumerate(test_seq):
    ...
    os.rename("../../Saliency_output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/forsingle/test_acid_avgscore.csv", "../output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/forsingle/%s_acid_avgscore.csv" % test_name[idx])
    os.rename("../../Saliency_output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/forsingle/test_acid_sumscore.csv", "../output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/forsingle/%s_acid_sumscore.csv" % test_name[idx])
    os.rename("../../Saliency_output/LCRs_process/forsingle/true_density_segment_statics.csv", "../../Saliency_output/LCRs_process/forsingle/%s_true_density_segment_statics.csv" % test_name[idx])
    os.rename("../../Saliency_output/LCRs_process/forsingle/max_segment.csv", "../../Saliency_output/LCRs_process/forsingle/%s_max_segment.csv" % test_name[idx])
...
os.rename("../../Saliency_output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/forsingle/test_statics.csv", "../output/gradCAM/gradCAM_noSoftmax_outAll_protein_score/forsingle/%s_statics.csv" % dataname)