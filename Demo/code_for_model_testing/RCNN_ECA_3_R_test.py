...
if __name__== '__main__':
    ...
    for i in range(len(pos_seed_list)):
        ...
        if not os.path.exists("../classification_output/PhasepDB_Reviewed_output"):
            os.makedirs("../classification_output/PhasepDB_Reviewed_output")
        auc_save_csv = '../classification_output/PhasepDB_Reviewed_output/rcnn_ECA_PDB_R_epoch100_roc_{}.csv'.format((i+1))
        result_save_csv = '../classification_output/PhasepDB_Reviewed_output/result.csv'
