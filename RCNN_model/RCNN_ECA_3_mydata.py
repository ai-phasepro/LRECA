...
if __name__== '__main__':
    ...
    for i in range(len(pos_seed_list)):
        ...
        pos_sequence,neg_sequence = readdata(root_dir, pos_protein_dir, neg_protein_dir, list_length, pos_seed, neg_seed) # list_length为废弃参数
        #x,y = readdata(root_dir, pos_protein_dir, neg_protein_dir)

        auc_save_csv = '../classification_output/dataset_RCNN_ECA_output/mydata_all_1507_output/RCNN_ECA_em1024_128_32_output/rcnn_ECA_mydata_epoch60_roc_{}.csv'.format((i+1))
        ...
        while start + interval <= 1:
            ...
            learning_rate = 1e-3  #1e-3, mydata上1e-4效果不行，其他数据集1e-4
